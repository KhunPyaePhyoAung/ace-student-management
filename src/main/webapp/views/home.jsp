	...
	<main class="container my-4">
		...
		<div class="row">
			<div class="text-center">
				...
				<c:set var="user" value="${loginUser.getUser()}"></c:set>
				<c:choose>
				...
				<span class="fw-bold">${sessionScope.loginUser.getUser().getId()}</span> : ${sessionScope.loginUser.getUser().getName()}
				<i class="fa-solid fa-clock ms-4"></i> : ${sessionScope.loginUser.getLoggedInDateTimeStirng()}
			</div>
		</div>
